...
This repository is a consolidation of two separate connector development efforts.

- **[JohnMcFarland/OpenCTI-Connectors](https://github.com/JohnMcFarland/OpenCTI-Connectors)** — Original source of several connectors in this repository and the primary inspiration for the design philosophy, data model conventions, and architecture documented here.

- **[OpenCTI-Platform/connectors](https://github.com/OpenCTI-Platform/connectors)** — The official OpenCTI connector repository maintained by Filigran, which serves as the upstream reference for connector architecture, pycti integration patterns, and deployment conventions.
