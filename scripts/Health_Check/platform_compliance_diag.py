...
# Token must be provided via environment variable — never hardcoded.
# Set OPENCTI_ADMIN_TOKEN in your shell or .env before running.
OPENCTI_URL = os.environ.get("OPENCTI_BASE_URL", "http://localhost:8080")
TOKEN = os.environ.get("OPENCTI_ADMIN_TOKEN")
if not TOKEN:
    raise RuntimeError("OPENCTI_ADMIN_TOKEN environment variable not set")
